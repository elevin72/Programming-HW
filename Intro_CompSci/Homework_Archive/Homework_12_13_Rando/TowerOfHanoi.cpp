...
/*
// This function is probably better and more semantic. We got rid of subTower as well
void SolveTower(int n, Tower* home, Tower* avail, Tower* dest){
    if(n == 0){
        return; 
    } 
    SolveTower(n-1, home, dest, avail); 
    Move(home, dest);
    return SolveTower(n-1, avail, home, dest);
} 
*/
